 ...
 * <p>
 * This is a subclass of {@link ConvolveFilter} which simply creates a kernel
  ...
  public BufferedImage filter(BufferedImage src, BufferedImage dst) {
    ...
    if (radius > 0) {
      convolveAndTranspose(kernel, inPixels, outPixels, width, height, alpha,
              alpha && premultiplyAlpha, false, CLAMP_EDGES);
      convolveAndTranspose(kernel, outPixels, inPixels, height, width, alpha,
              false, alpha && premultiplyAlpha, CLAMP_EDGES);
    }
