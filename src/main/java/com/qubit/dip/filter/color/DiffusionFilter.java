 ...
 * Floyd-Steinberg error diffusion dithering. It generally produces better
 * results than ordered dithering, with less distinct "patterning". You can
 * choose straight or serpentine dithering and the number of color levels to
 * dither to.
 * </p>
 *
